package com.jyp.studydemo.classloader;
...
/**
 * @author ：jiyuepeng
 * @date ：Created in 2020/11/20 8:57
    ...
    public static void main(String args[]) throws MalformedURLException {
        ...
        try {
            URL[]   urls =   new   URL[]   {   new   URL
                    ("file:/D:/projects/study/study-demo/target/classes/com/jyp/studydemo/classloader/") };
            HotSwapClassLoader c1 = new HotSwapClassLoader
                    (urls, a.getClass().getClassLoader());
            Class clazz = c1.load("A");  // 用hot swap重新加载类A
